    ...
    <Container>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={6} md={3}>
          ...
          {tasksOfProject.length > 0 && renderTaskCards(tasksOfProject.filter((task) => task.status === "Pending"))}
          {user.role === "Manager" && (
            <Card className={isHovered ? "task-card-hovered" : "task-card"}
              sx={{
                mb: "10px",
                width: "100%",
                height: "40px",
        ...
        <Grid item xs={12} sm={6} md={3}>
          ...
          {tasksOfProject.length > 0 && renderTaskCards(tasksOfProject.filter((task) => task.status === "Working"))}
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={3}>
          ...
          {tasksOfProject.length > 0 && renderTaskCards(tasksOfProject.filter((task) => task.status === "Review"))}
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={3}>
          ...
          {tasksOfProject.length > 0 && renderTaskCards(tasksOfProject.filter((task) => task.status === "Done"))}
        </Grid>
      </Grid>
    </Container>
  );
